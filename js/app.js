...
function renderTrial(this) {
  var h1Name = document.createElement('h1');
  h1Name.textContent = this.title;
  var h3Region = document.createElement('h3');
  h3Trail.textContent = this.trail;
  var h3Difficulty = document.createElement('h3');
  h3Difficulty.textContent = this.entry;
  journal.appendChild(h1Name);
  journal.appendChild(h3Region);
  journal.appendChild(h3Difficulty);
}
